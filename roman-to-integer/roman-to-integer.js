...
var romanToInt = function(s) {
    ...
    // Tersten işlemek için stringin sonundan başlıyoruz
    for (let i = s.length - 1; i >= 0; i--) {
        const currentValue = romanMap.get(s[i]);

        // Eğer önceki rakam, şu anki rakamdan büyükse çıkarma yapılır, aksi halde toplama
        ...
        // Bir sonraki döngüde önceki rakamı kıyaslamak için currentValue'yi kaydediyoruz
